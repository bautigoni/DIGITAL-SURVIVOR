...
export const ZONES = {
    social_media: {
        ...
        description: 'Millones de voces. Likes que compran, perfiles que mienten. Aprendé a leer entre líneas.',
        palette: {
            primary: '#ec4899',
            secondary: '#f472b6',
            accent: '#fbbf24',
    ...
    gaming: {
        ...
        description: 'Robux, V-Bucks, hacks… los atajos siempre tienen un precio. Identificá las ofertas imposibles.',
        palette: {
            primary: '#22d3ee',
            secondary: '#06b6d4',
            accent: '#a78bfa',
    ...
    news: {
        ...
        description: 'Titulares diseñados para viralizar, no para informar. Verificá antes de compartir.',
        palette: {
            primary: '#facc15',
            secondary: '#fb923c',
            accent: '#f43f5e',
    ...
    shopping: {
        ...
        description: 'Tiendas espejo, tarjetas clonadas y precios ridículos. Aprendé a comprar sin caer.',
        palette: {
            primary: '#34d399',
            secondary: '#10b981',
            accent: '#fde047',
    ...
    ai: {
        ...
        description: 'Imágenes, voces y videos fabricados con precisión milimétrica. Tu ojo ya no alcanza.',
        palette: {
            primary: '#a78bfa',
            secondary: '#8b5cf6',
            accent: '#22d3ee',
    ...
    dark_network: {
        ...
        description: 'Manipulación emocional, suplantación y cadenas. La amenaza más humana de Internet.',
        palette: {
            primary: '#7c3aed',
            secondary: '#1e1b4b',
            accent: '#f43f5e',
